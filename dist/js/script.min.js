...
var demo=["Animal.zip","Chisel.zip","Flansmod.zip","furniture.zip","LegacyJavaFixer.zip","Chisel.zip","Animal.zip","Chisel.zip","Flansmod.zip","furniture.zip","LegacyJavaFixer.zip","Chisel.zip"];jQuery(function(a){a("#menu a").click(function(i){i.preventDefault(),a("#menu a.active").removeClass("active"),a(this).addClass("active");var e=parseInt(a(this).attr("data-tab").replace("pane-",""))-1;a("#panes").animate({left:390*-e}),console.log("dr")})});